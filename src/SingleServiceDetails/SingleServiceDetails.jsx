...
const SingleServiceDetails = () => {
  ...
  const openModal = () => {
    Swal.fire({
      ...
      html: `
        <p class=" mb-4">Service Name:${service.serviceName}</p>
        <p class="rounded"><img src="${service.ServicePhoto}" alt="Service Image" class="rounded" ></p>
        <p class="mt-5 text-blue-600">Service Provider Email: ${service.email}</p>
        <p class="mt-5 text-blue-600">User Email: ${user.email}</p>
        <label for="serviceTakingDate"></label>
        <input type="date" id="serviceTakingDate" class="swal2-input" required>
        <label for="specialInstruction"></label>
        <input type="text" id="specialInstruction" class="swal2-input" placeholder="Your Location" required>        
        <p class="mt-5 text-blue-600">Price: ${service.ServicePrice}</p>

      `,
      showCancelButton: true,
      confirmButtonText: "Purchase this Service",
      preConfirm: () => {
        const serviceTakingDate =
          Swal.getPopup().querySelector("#serviceTakingDate").value;
        const specialInstruction = Swal.getPopup().querySelector(
          "#specialInstruction"
        ).value;
  ...
  return (
    <div>
      ...
      <div>
        <div>
          <div className="w-full overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mx-auto mt-10">
            <img
            ...
            <div className="p-6">
              <div>
                ...
                <div className="flex">
                  ...
                  <h1 className="mb-2 text-blue-600 ml-1">
                    {service.ServiceArea}
                  </h1>
                </div>
              ...
              <Link className="flex justify-end">
                <button
                  onClick={openModal}
                  className="flex justify-end font-semibold py-2 md:py-1 bg-blue-500 px-3 md:px-2 rounded text-white"
                >
                  Book Now
                </button>
              </Link>
