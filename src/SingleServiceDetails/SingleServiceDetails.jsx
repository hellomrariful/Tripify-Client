...
//                 <button className=" flex justify-end font-semibold py-2 md:py-1 bg-blue-500 px-3 md:px-2 rounded   text-white">
//                   Book Now
//                 </button>
//               </Link>
//             </div>
  ...
  const openModal = () => {
    Swal.fire({
      ...
      html: `
        ...
        <p>Service Image: <img src="${service.ServicePhoto}" alt="Service Image" style="max-width: 100px;" class="rounded-full"></p>
        <p>Service Provider Email: ${service.email}</p>
        <p>User Email: ${user.email}</p>
        <label for="serviceTakingDate"></label>
        <input type="date" id="serviceTakingDate" class="swal2-input">
        <label for="specialInstruction"></label>
        <input type="text" id="specialInstruction" class="swal2-input">
