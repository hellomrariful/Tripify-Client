        ...
        <div className="max-w-5xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mx-auto mt-10">
          ...
          <div className="p-6">
            <div>
              ...
              <h1 className="mb-2 text-blue-600">{service.ServiceArea}</h1>
              <a
                href="#"
            ...
            <button
              ...
              className="font-semibold py-2 md:py-1 bg-blue-500 px-3 md:px-2 rounded  text-white flex justify-end text-center  mx-auto"
            >
              Book Now
            </button>
          </div>
